function Score = flappybird2(rn)
if (~nargin)
    rn = 1;
end
rng(rn); %random number generator
switch rn   %name the file for collecting data
    case 1
        file1 = 'FlappyDataSeed1max.txt';
    case 2
        file1 = 'FlappyDataSeed2i.txt';
    case 3
        file1 = 'FlappyDataSeed3i.txt';
    case 4
        file1 = 'FlappyDataSeed4i.txt';
    case 5
        file1 = 'FlappyDataSeed5i.txt';
    case 6
        file1 = 'FlappyDataSeed6i.txt';
    case 7
        file1 = 'FlappyDataSeed7i.txt';
    case 8
        file1 = 'FlappyDataSeed8i.txt';
    case 9
        file1 = 'FlappyDataSeed9i.txt';
    case 10
        file1 = 'FlappyDataSeed10i.txt';
end
...
n = 80;
j = n+1;
PosY = 1*ones(n,1); %initial guess for y positions
SpeedY = 0*ones(n,1); %initial guess for Y speeds
J = 1*ones(n,1); %initial guess for jumps
xnew = [PosY;SpeedY;J]; % vector of initial guesses
h1 = plot(45,45);
h2 = plot(45,45);
h3 = plot(45,45);
pause(10);
...
%                  end
               ...
               if j > n
                   [J,exitflag,bcon,tcon,opttime,PosYnew,fval,xnew] = FlappyMixIntOptFun(Tubes.FrontP,Tubes.VOffset,...
                       Bird.ScreenPos,Tubes.ScreenX,Bird.SpeedY,n,SecondP,xnew);
                   
                   %write data to file
%                    FlappyData = [fval, opttime, xnew', Tubes.FrontP,Tubes.VOffset,...
%                        Bird.ScreenPos,Tubes.ScreenX,Bird.SpeedY,n,SecondP,bcon',tcon'];
%                    dlmwrite(file1,FlappyData,'-append');
               ...
               set(h2,'Visible','off')
               set(h3,'Visible','off')
               h1 = plot(tplot+46-j,yplot,'r','LineWidth',1); %plot path
...
%% Game Logic
    ...
    function scrollTubes(offset)
        ...
        if Tubes.ScreenX(Tubes.FrontP) <= 8
